...
<div class="row">
    <div class="col-md-8">
        ...
        <x-form.textarea id="description" name="Desription" label="Desription" value="{{ $product->desription }}" />
        <x-form.error name="{{$name}}" />

        <x-form.textarea id="short_description" name="short_description" label="Short_Description" value="{{ $product->short_description }}" />
        <x-form.error name="{{$name}}" />
